...
const CATEGORY_LABELS_TEXT: Record<TrashCategory, string> = {
  burnable: "Burnable",
  nonBurnable: "Non-Burnable",
  cans: "Cans",
  bottles: "Bottles",
...
export default function TrashScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--color-surface)" }}>
      ...
      {/* No village selected */}
      {!villageId ? (
        <div className="px-4 py-8 text-center text-gray-400" role="status">
          <p className="mb-3">No village selected.</p>
          <button
        ...
        <>
          ...
          {activeRule ? (
            <div
              ...
              role="tabpanel"
              aria-label={CATEGORY_LABELS_TEXT[activeCategory]}
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <ol className="flex flex-col gap-3" aria-label="Instructions">
