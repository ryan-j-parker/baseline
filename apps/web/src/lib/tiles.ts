...
export const HOME_TILES: QuickTile[] = [
  ...
  { id: "phone",           title: "Phone & Internet",  icon: "📱", route: "/utilities",       priority: 7,  isLive: true },
  { id: "groceries",       title: "Groceries",         icon: "🛒", route: "/groceries",       priority: 8,  isLive: true },
  { id: "maps",            title: "Maps",              icon: "🗺️", route: "/maps",            priority: 9,  isLive: true },
  { id: "instant-answers", title: "Instant Answers",   icon: "✨", route: "/instant-answers", priority: 10, isLive: true },
];